...
public final class IncidentTicket {
    ...
    public static class Builder {
        ...
        public Builder reporterEmail(String email) {
            Validation.requireEmail(email, "reporterEmail");
        ...
        public Builder assigneeEmail(String email) {
            if (email != null) Validation.requireEmail(email, "assigneeEmail");
        ...
        public Builder slaMinutes(Integer slaMinutes) {
            Validation.requireRange(slaMinutes, 1, 10_000, "slaMinutes");
